...
public class PokemonServiceTest {
  ...
  public void setUp() {
    ...
    pokeApiHttpRequestHelper =
        HttpRequestHelper.forGet(
            pokeApiRestClient, pokeApiRequestHeadersUriSpec, pokeApiResponseSpec);
    ...
    translationHttpRequestHelper =
        HttpRequestHelper.forPost(
            translationRestClient,
            translationRequestBodyUriSpec,
            translationRequestBodySpec,
            translationResponseSpec);
  ...
  @Test(
      expectedExceptions = PokemonNotFoundException.class,
      expectedExceptionsMessageRegExp = "Pokemon not found: nonexistent")
  ...
  @Test(
      ...
      expectedExceptionsMessageRegExp = "Pokemon name cannot be null or empty")
  ...
  public void testGetTranslatedPokemonByName_LegendaryUsesYoda() {
    ...
    Map<String, Object> translationResponse =
        createTranslationResponse(translatedText, TRANSLATION_TYPE_YODA);
    translationHttpRequestHelper.mockPostRequestMap(
        TRANSLATE_PATH, TRANSLATION_TYPE_YODA, translationResponse);
  ...
  public void testGetTranslatedPokemonByName_OtherUsesShakespeare() {
    ...
    Map<String, Object> translationResponse =
        createTranslationResponse(translatedText, TRANSLATION_TYPE_SHAKESPEARE);
    translationHttpRequestHelper.mockPostRequestMap(
        TRANSLATE_PATH, TRANSLATION_TYPE_SHAKESPEARE, translationResponse);
  ...
  public void testGetTranslatedPokemonByName_TranslationFails_ReturnsOriginal() {
    ...
    pokeApiHttpRequestHelper.mockGetRequestMap(POKEMON_SPECIES_PATH, pokemonName, apiResponse);
    translationHttpRequestHelper.mockPostRequestMap(
        TRANSLATE_PATH, TRANSLATION_TYPE_SHAKESPEARE, new HashMap<>());
  ...
  @Test(
      expectedExceptions = PokemonNotFoundException.class,
      expectedExceptionsMessageRegExp = "Pokemon not found: pikachu")
  ...
  private void verifyResultAndMocks(
      PokemonDTO result, PokemonDTO expected, boolean verifyTranslation) {
    assertNotNull(result);
    assertEquals(result, expected);

    verify(pokeApiRestClient, times(1)).get();
    verify(pokeApiRequestHeadersUriSpec, times(1))
        .uri(eq(POKEMON_SPECIES_PATH), eq(result.getName()));
    ...
    if (verifyTranslation) {
      ...
      String translationType =
          (expected.isLegendary() || HABITAT_CAVE.equalsIgnoreCase(expected.getHabitat()))
              ? TRANSLATION_TYPE_YODA
              : TRANSLATION_TYPE_SHAKESPEARE;
